...
<body>
    ...
    // Verifica se 'id' está definido na URL
        ...
        if(isset($_POST['atualizar'])){
            ...
            switch ($parte) {
                case 1:
                    $sql = "UPDATE $serie SET atv1_1 = ?, atv2_2 = ?, atv3_3 = ?, resultado_av1 = ? WHERE id_primeiro = ?";
                    break;
                case 2:
                    $sql = "UPDATE $serie SET atv2_1 = ?, atv2_2_2 = ?, atv2_3 = ?, resultado_av2 = ? WHERE id_primeiro = ?";
                    break;
                case 3:
                    $sql = "UPDATE $serie SET atv3_1 = ?, atv3_2 = ?, atv3_3_3 = ?, resultado_av3 = ? WHERE id_primeiro = ?";
                    break;
                case 4:
                    $sql = "UPDATE $serie SET atv4_1 = ?, atv4_2 = ?, atv4_3 = ?, resultado_av4 = ? WHERE id_primeiro = ?";
                    break;  
                case 5:
                    $sql = "UPDATE $serie SET atv5_1 = ?, atv5_2 = ?, atv5_3 = ?, resultado_av5 = ? WHERE id_primeiro = ?";
                    break;  
                case 6:
                    $sql = "UPDATE $serie SET atv6_1 = ?, atv6_2 = ?, atv6_3 = ?, resultado_av6 = ? WHERE id_primeiro = ?";
                    break;         
            ...
            $stmt->close();
            header('location: alunos.php?idv='.$idv);
    ...
    <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
        ...
        <input type="hidden" name="parte" value="<?php echo $_GET['parte']; ?>">
        <input type="hidden" name="idv" value="<?php echo $_GET['idv']; ?>">
